  ...
  return (
    <div className="departments mb-4 py-3">
      <div className="introText">
        ...
        <p>
          View the various departments in the fellowship and their purpose with
          regards to the smooth running of the church.
        </p>
        <Button text={"View now"} color={"black"} bg={"#F7EDE8"} icon={Arrow} />
      </div>
      <div className="image">
